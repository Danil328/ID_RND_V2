...
from utils.metrics import idrnd_score_pytorch, far_score, frr_score
...
if __name__ == '__main__':
    ...
    model = Model(base_model=resnet101(pretrained=True))
    ...
    keker = Keker(model=model,
                  ...
                  criterion=criterion,
                  target_key="label",
                  metrics={"acc": accuracy, "roc_auc": roc_auc, "idrnd_score": idrnd_score_pytorch, "FAR": far_score,
                           "FRR": frr_score},
