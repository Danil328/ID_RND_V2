...
from Dataset.id_rnd_dataset import IDRND_dataset_CV, PretrainDataset
...
def evaluate(model, val_loader, epoch, model_name):
    ...
    torch.save(model.state_dict(), f"../output/models_weights/pretrained/{model_name}_{epoch}_{score}_{user_score}.pth")
...
if __name__ == '__main__':
    ...
    for model_name in model_names:
        config_path = f'../output/logs/pretrained_{model_name}'
